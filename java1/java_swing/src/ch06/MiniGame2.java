	...
	public void keyPressed(KeyEvent e) {
		...
		if (keyCode == KeyEvent.VK_LEFT) {
			...
			if (backgroundCount == 0) {
				...
				try {
					backgroundImg = ImageIO.read(new File("Images/background3.jpg"));
				} catch (IOException e1) {
					e1.printStackTrace();
				}
				backgroundCount++;
				...
				try {
					backgroundImg = ImageIO.read(new File("Images/background4.jpg"));
				} catch (IOException e1) {
					e1.printStackTrace();
				}
				backgroundCount++;
				...
				try {
					backgroundImg = ImageIO.read(new File("Images/background5.png"));
				} catch (IOException e1) {
					e1.printStackTrace();
				}
				backgroundCount++;
