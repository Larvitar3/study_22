...
public class OperatorEx1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("2번문제 답 : " + (int) result1);

		// 3
		// i 변수의 값을 -1을 뺀 후 출력하세요
		// 단, 단항 연산자 사용
		i--;
		System.out.println("3번문제 답 : " + i);

		// 4
		// d 변수에 값을 -20.5로 출력 하세요
		// 단, d 변수에 값을 변경하지 마세요
		System.out.println("4번문제 답 : " + -d);
		...
		// 출력하세요
		boolean result2 = (i < d);
		System.out.println("5번문제 답 : " + result2);
		...
		System.out.println("6번문제 답 : " + result3);
